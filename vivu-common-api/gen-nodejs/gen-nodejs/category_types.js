...
vv.models.Category = module.exports.Category = function(args) {
  this.id = null;
  this.name = null;
  this.priority = null;
  this.notes = null;
...
vv.models.Category.prototype = {};
vv.models.Category.prototype.read = function(input) {
...
vv.models.Category.prototype.write = function(output) {
  ...
  if (this.categoryGroupId !== null && this.categoryGroupId !== undefined) {
    output.writeFieldBegin('categoryGroupId', Thrift.Type.I32, 12);
